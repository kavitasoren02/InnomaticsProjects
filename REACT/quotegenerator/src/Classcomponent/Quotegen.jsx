...
export default class Quotegen extends Component {
    ...
    constructor(){
        ...
        this.state={
            ...
            image:"https://static.vecteezy.com/system/resources/thumbnails/053/482/382/small/heart-shaped-moss-sculpture-in-lush-green-field-nature-art-concept-for-eco-friendly-design-photo.jpg",
        }
    }
    motivationalQuotes = [
        {
      ...
      generateQuote=()=>{
        ...
        this.setState({
            quote:this.motivationalQuotes[randomIndex].text,
            image:this.motivationalQuotes[randomIndex].image,
        });
      };

      componentDidMount() {
        this.interval = setInterval(this.generateQuote, 2000);
      }
  ...
  render() {
    return (
      < >
        <div style={{...styles.container,backgroundImage: `url(${this.state.image})`}}>
            <div style={styles.overlay}>
                <h2>😊 Random Quote Generator</h2>
                <p style={styles.quote}>{this.state.quote}</p>
